...
\begin{abstract}
    ...
    O foco principal de estudo são pushqouts na categorias de espaços e funções contínuas, mas isso naturalmente requer o estudo de algumas propriedades gerais de pushouts, assim como o estudo de propriedades particulares de pushouts na categoria de conjuntos.
